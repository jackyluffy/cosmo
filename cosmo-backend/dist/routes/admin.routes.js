...
exports.AdminController = exports.adminRoutes = void 0;
...
const AdminController = {
    ...
    generateTestUsers: async (req, res) => {
        try {
            ...
            const targetUserDoc = await firebase_1.db.collection('users').doc(targetUserId).get();
            ...
            const generateRandomLocation = (centerLat, centerLng, radiusMiles) => {
            ...
            const swipeBatch = firebase_1.db.batch();
    ...
    updateTestUserProfiles: async (req, res) => {
        try {
            const { 
            // Location options
            ...
            const generateRandomLocation = (lat, lng, radius) => {
    ...
    seedUsers: async (req, res) => {
        try {
            ...
            const generateRandomLocation = () => {
                ...
                return new firestore_1.GeoPoint(lat, lng);
            };
            const firstNames = [
            ...
            for (let i = 0; i < 20; i++) {
                ...
                const userData = {
                    ...
                    subscription: {
                        ...
                        expiresAt: firestore_1.Timestamp.fromDate(new Date('2026-12-31')),
                    },
                    createdAt: firestore_1.Timestamp.now(),
                    updatedAt: firestore_1.Timestamp.now(),
                };
...
const suspendUserSchema = joi_1.default.object({
    ...
    duration: joi_1.default.number().min(1).max(365).required(), // days
});
const resolveReportSchema = joi_1.default.object({
...
const analyticsSchema = joi_1.default.object({
    ...
    metric: joi_1.default.string().valid('users', 'events', 'matches', 'revenue'),
});
const announcementSchema = joi_1.default.object({
    title: joi_1.default.string().required(),
    message: joi_1.default.string().required(),
    targetUsers: joi_1.default.string().valid('all', 'active', 'premium'),
});
...
// Routes
router.get('/users', (0, validation_middleware_1.validateRequest)(getUsersSchema, 'query'), AdminController.getUsers);
router.get('/users/:userId', AdminController.getUser);
router.put('/users/:userId', AdminController.updateUser);
router.post('/users/:userId/suspend', (0, validation_middleware_1.validateRequest)(suspendUserSchema), AdminController.suspendUser);
router.get('/reports', AdminController.getReports);
router.put('/reports/:reportId/resolve', (0, validation_middleware_1.validateRequest)(resolveReportSchema), AdminController.resolveReport);
router.get('/analytics', (0, validation_middleware_1.validateRequest)(analyticsSchema, 'query'), AdminController.getAnalytics);
router.post('/announcements', (0, validation_middleware_1.validateRequest)(announcementSchema), AdminController.createAnnouncement);
